...
<body>
    ...
    <!--  wrapper then sections then container  -->
    <div class="wrapper">
        <section id="intro" class="intro-container">
            <!--  VIDEO HERE  -->
            <video class="video-bg" preload="auto" autoplay="true" loop="loop" muted="true" volume="0">
            	<source src="videos/soccer.mp4" type="video/mp4"></source>
                <source src="videos/soccer.webm" type="video/webm"></source>
            </video>
            ...
            <div id="about" class="about-container">
                ...
                <div class="row">
                    ...
                    <div class="medium-6 large-4  columns">
                        <h3 class="center-text">Team Information</h3>
                        <p>
                    ...
                    <div class="medium-6 large-4  columns">
                        <h3 class="center-text">Community Involvement</h3>
                        <p>
                        ...
                        local youth club, Delaware County Futbol Club, as coaches to provide the club with a new perspective in soccer. Many of our players are not from the Muncie area, this allows the teams to be coached
                        in a different style than they may be used to. This experience not only allows our players to gain leadership experience, but also continue doing something they love while giving back to the community.<br/><br/>
                        ...
                        <div class="row">
                            <table> 
                                ...
                                <tbody> 
                                    ...
                                    <tr> 
                                        <td>September 14th, 2014 - 1:00pm</td> 
                                        <td>Ball State University</td>
        ...
        <section class="venues">
            <div id="venues" class="venues-container">
                <div class="row">
                    <div class="top-title">
                        Our Venues
                    </div>
                    ...
                    <div class="large-6 columns">
                        ...
                        <?php 
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                if($totaltime < 10) {
                                ...
                                else if (!empty($_POST['caughtyou'])){
                                    // Twas a mere bot
                                    echo "<script></script>";
                                }
                                else{
                                    $contact_name        = trim(strip_tags($_POST['name']));
                                    $contact_email       = trim(strip_tags($_POST['contact_email']));
                                    $contact_message     = trim(strip_tags($_POST['contact_message']));
                             
                                    $to             =       'BSU Club Soccer <soccer@bsu.edu>';
                                    $subject        =       'New Message ('.$contact_name.')';
                                    $message        =       "A message from: ".$contact_name. " with email: ".$contact_email."<br/><br/> The message: ".$contact_message;
                                    ...
                                    $headers    = array(
                                        ...
                                        'From: BSU Mens Club Soccer <soccer@bsu.edu>',
                                        'Reply-To: BSU Mens Club Soccer <soccer@bsu.edu>',
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER[" php_self"]);?>" method="POST">
                            <div class="row special">
                                <div class="large-12">
                                    <label>Name
                                        <input type="text" name="name" placeholder="ex. Derek Onay" required=""/>
                                    </label>
                                </div>                            
                                <div class="large-12">
                                    <label>Email
                                        <input type="email" name="contact_email" placeholder="ex. test@gmail.com" required=""/>
                                    </label>
                                    <div class="sneaky">
                                        <input type="hidden" name="loadtime" value="<?php echo time(); ?>"/>                                    
                                    </div>
                                    <p class="form-tester">                                       
                                        <input type="text" tabindex="-1" name="caughtyou" value="" alt="filling in this form will not send your data"/>
                                    </p>
                                </div>                            
                                <div class="large-12">
                                    <label>Message
                                        <textarea name="contact_message" placeholder="Please tell us about yourself and your soccer career, or anything you think we'd like to hear..." required=""></textarea>
                                    </label>
                                </div>
                                <div class="large-12">
                                    <button class="flat-button submit" type="submit">Submit Form</button>
                                </div>
                            </div>
                        </form>
                    </div>                    
